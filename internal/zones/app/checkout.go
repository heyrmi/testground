...
func checkout() challenge.Challenge {
	return challenge.Challenge{
		...
		Selectors: []challenge.Selector{
			...
			{TestID: "go-to-payment", Role: "button", Note: "Leaves the browse step; disabled while the cart is empty"},
			...
			{TestID: "back-to-browse", Role: "button", Transient: true, Note: "Returns to the catalogue from the payment step; the cart survives it"},
			...
			{TestID: "shop-again", Role: "button", Transient: true, Note: "Starts a second checkout; the cart it returns to was emptied by the order"},
